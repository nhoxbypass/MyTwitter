...
<img src='http://i.imgur.com/mQtWjaM.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
- [RestClientTemplate](https://travis-ci.org/codepath/android-rest-client-template) - RestClientTemplate is a skeleton Android project that makes writing Android apps sourced from OAuth JSON REST APIs as easy as possible. This skeleton project
